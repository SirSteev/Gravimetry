...
namespace Toolbox
{
    ...
    public class Lazarus : GlobalSingletonMonoBehaviour<Lazarus>
    {
        ...
        public static void RelenquishToPool(GameObject gameObject)
        {
            ...
            //don't use pools during editmode, it fucks everything // lol
            #if UNITY_EDITOR
            if (!Application.isPlaying)
            {
                ...
                //if (prefabType == UnityEditor.PrefabType.None || (int)prefabType >= (int)UnityEditor.PrefabType.PrefabInstance)
                if (prefabType == UnityEditor.PrefabAssetType.NotAPrefab && prefabStatus == UnityEditor.PrefabInstanceStatus.NotAPrefab ||
                        (int)prefabStatus >= (int)UnityEditor.PrefabInstanceStatus.Disconnected)
